...
export const DesignChallengeGrow = () => {
  return (
    <article className="component-container">
      <h1 className="grow">Grow your skills with confidence</h1>
      <section className="both-cards">
        <div className="card-one">
          <div className="sub-card">
            ...
            <h3 className="subtext">Gain practical knowledge</h3>
            <p>
              Gain practical knowledge in any design path. Learn techniques and
              practice with modern briefs that would speed up your skills.
            </p>
          </div>
        </div>
        ...
        <div className="card-two">
          <div className="sub-card">
            ...
            <h3 className="subtext">Build your portfolio</h3>
            <p>
    ...
    //   <section>
    //   <article className="both-cards">
    //     <article className="shadowed-container-one">
    //       <div className="card">
    //         <div className="svg-one-cont">
    //           <svg
    //             xmlns="http://www.w3.org/2000/svg"
    //             width="24"
    //             height="24"
    ...
    //         <h2 id="subtext">Gain Practical Knowledge</h2>
    ...
    //     <article className="shadowed-container-two">
    //       <div className="card">
    ...
    //         <h2 id="subtext">Build Your Portfolio</h2>
    //         <p className="para-text">
    //           Gain practical knowledge in any design path. Learn techniques and
    //           practice with modern briefs that would speed up your skills.
    //         </p>
